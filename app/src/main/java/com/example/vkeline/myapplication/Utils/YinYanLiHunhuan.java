...
public class YinYanLiHunhuan {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(YinYanLiHunhuan.lunarToSolar("19901204", false));
        System.out.println(YinYanLiHunhuan.lunarToSolar("19841021", true));
        System.out.println("************");
        System.out.println(YinYanLiHunhuan.solarToLunar("19000923"));
        System.out.println(YinYanLiHunhuan.solarToLunar("19000924"));
        System.out.println(YinYanLiHunhuan.solarToLunar("19001022"));
        System.out.println(YinYanLiHunhuan.solarToLunar("19001023"));

        System.out.println(YinYanLiHunhuan.solarToLunar("19900630"));
        System.out.println(YinYanLiHunhuan.solarToLunar("19841213"));
        System.out.println(YinYanLiHunhuan.solarToLunar("19910119"));
    }
