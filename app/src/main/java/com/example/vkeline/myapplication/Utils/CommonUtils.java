...
public class CommonUtils {
    ...
    public static Integer tiangandefen(String param){
        if("比".equals(param)){
            return 7;
        }
        if("劫".equals(param)){
    ...
    public static Integer dishidefen(String param,String flag){
        if ("帝".equals(param)){
            if("rizhi".equals(flag)){
                return 20;
            }else if("dishi".equals(flag)){
                return 40;
            }else if ("qitadizhi".equals(flag)){
                return 10;
            }
        }
        if ("临".equals(param)){
    ...
    public static String yinyang(String paramString) {
        if ((paramString.equals("甲"))||(paramString.equals("丙"))||(paramString.equals("戊"))||(paramString.equals("庚"))||(paramString.equals("壬"))||(paramString.equals("子")) || (paramString.equals("寅")) || (paramString.equals("辰")) || (paramString.equals("午")) || (paramString.equals("申")) || (paramString.equals("戌"))) {
            return "阳";
        }
        if ((paramString.equals("乙"))||(paramString.equals("丁"))||(paramString.equals("己"))||(paramString.equals("辛"))||(paramString.equals("癸"))||(paramString.equals("丑")) || (paramString.equals("卯")) || (paramString.equals("巳")) || (paramString.equals("未")) || (paramString.equals("酉")) || (paramString.equals("亥"))) {
            return "阴";
        }
        return "";
    }
